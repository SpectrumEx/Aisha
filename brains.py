...
#new = ['тест1']
random_ballsay = ['Да', 'Нет', 'Спроси позже', 'Возможно', 'Определенно', 'Точно нет', 'Я бы не стал этого делать', 'Маловероятно', 'Конечно']

random_message = lambda: random.choice(say)
random_ball = lambda: random.choice(random_ballsay)
aboutme = "Aisha - v.0.1 created by @Yanderea\n\nMy forum - https://sterben.ru"